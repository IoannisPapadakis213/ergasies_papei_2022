  ...
  while gamerunning != True:
    ...
    if spot=="th3":
      if th3==0 and check(ring):
        ...
        th3=ring
        moves+=1
      elif th3==3 and check(spot) and spot!=3:
          th3=ring
          moves+=1
    ...
    if spot=="th4":
      if th4==0 and check(ring):
          th4=ring
          moves+=1
      elif th4==1 and check(spot) and spot!=1:
        th4=ring
        moves+=1
      elif th4==2 and check(spot) and spot!=2:
        th4=ring
        moves+=1
      elif th4==3 and check(spot)and spot!=1:
          th4=ring
          moves+=1
